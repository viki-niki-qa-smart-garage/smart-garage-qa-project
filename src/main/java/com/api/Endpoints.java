...
public class Endpoints {
    ...
    public static final String CREATE_CUSTOMER = "/users/customers";
...
//    public static final String GET_CLIENT_CARS_SERVICE_HISTORY = "/users/{id}/service-history";
//    public static final String GET_CONCRETE_CAR_SERVICE = "/client-cars/{clientCarId}/services";
    ...
    public static final String UPDATE_CAR_DETAILS = "/client-cars/{clientCarId}";
